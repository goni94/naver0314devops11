...
class MyShop
{
	...
	public final static String SHOP = "24시간이마트";
	...
	//overloading method(중복함수): 메서드명은 같으나 인자(파라미터)가 달라야 한다
	public void setData(String sangpum,int su,int dan,String message)
	{
		...
		this.setDan(dan);
		this.setSu(su);
		//인스턴스 메서드에서 static 메서드 호출이 가능할까요? ok
		//반대로 static 메서드에서 인스턴스 멤버 메서드를 호출할수 있을까요? no
		//static 메서드에서 같은 static 메서드는 호출이 가능할까요? ok
